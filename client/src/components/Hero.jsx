      ...
      <div className="hero-inner">
        ...
        <div className="hero-container">
          ...
          <div className="hero-cta fade-in-up" style={{ animationDelay: '0.4s' }}>
            ...
            <a
              href="https://drive.google.com/file/d/1pQxlMFyDnML9d2x5G5461pP0i0pDylxO/view?usp=drive_link"
              target="_blank"
              rel="noreferrer"
        ...
        {/* Right: Profile Photo */}
        <div className="hero-photo-wrapper fade-in-up" style={{ animationDelay: '0.3s' }}>
          <div className="hero-photo-glow"></div>
          <img src={profilePhoto} alt="Ashmit Choudhary" className="hero-photo" />
        </div>
